...
public class DalyCityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daily_city);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            JSONObject firsTrain = estimate.getJSONObject(0);
                            String firsTrainMinutes = firsTrain.getString("minutes");
                            ...
                            firstTrainTextView.setText(firsTrainMinutes);
